...
function runBaseTests() {
  px_file_upload_1 = document.getElementById('px_file_upload_1');

  suite('Base Automation Tests for px-file-upload', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-file-upload fixture is created', function() {
      assert.isTrue(document.getElementById('px_file_upload_1') !== null);
    });
